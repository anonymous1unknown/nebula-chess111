...
from sqlalchemy import String, ForeignKey, DateTime, Float, Integer, Text, Boolean
...
class CheatFlag(Base):
    ...
    # FIX: migration stores this as String(16) — native_enum=False prevents type mismatch
    status: Mapped[CheatFlagStatus] = mapped_column(
        SAEnum(CheatFlagStatus, native_enum=False, name="cheatflagstatus"),
        default=CheatFlagStatus.pending,
    )
